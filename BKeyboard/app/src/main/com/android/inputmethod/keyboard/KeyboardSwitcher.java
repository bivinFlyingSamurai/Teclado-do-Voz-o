...
import com.ceara.club.keyboard.fragment.LanguageFragment;
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public void loadKeyboard(final EditorInfo editorInfo, final SettingsValues settingsValues,
        ...
        prefs = PreferenceManager.getDefaultSharedPreferences(mThemeContext);
        String currentKeyboard = prefs.getString(LanguageFragment.CURRENT_KEYBOARD,
        ...
        if (currentLanguage.length() > 3) {
            ...
            String country = currentLanguage.substring(3);
        ...
        InputMethodSubtype subtype = mRichImm.findSubtypeByLocaleAndKeyboardLayoutSet(
                currentLocale.toString(), currentKeyboard);
...
//            mKeyboardTextsSet.setLocale(mRichImm.getCurrentSubtypeLocale(), mThemeContext);
            mKeyboardTextsSet.setLocale(currentLocale, mThemeContext);
    ...
    private void setKeyboard(@Nonnull final int keyboardId,
        ...
        final boolean hasMultipleEnabledIMEsOrSubtypes = mRichImm
                .hasMultipleEnabledIMEsOrSubtypes(false /* shouldIncludeAuxiliarySubtypes */);
    ...
    public void setEmojiKeyboard() {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mThemeContext);
        int background = prefs.getInt(Settings.PREF_CURRENT_BACKGROUND, R.drawable.bgi4);
        mEmojiPalettesView.setBackground(null);
        mEmojiPalettesView.setEmojiBackground(R.drawable.bgi5);

//        mEmojiPalettesView.setBackgroundResource(background);
    }
    ...
    public View onCreateInputView(final boolean isHardwareAcceleratedDrawingEnabled) {
        ...
        updateBackground(mKeyboardView);

        return mCurrentInputView;
    }

    private void updateBackground(MainKeyboardView mKeyboardView) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mThemeContext);
        int background = prefs.getInt(Settings.PREF_CURRENT_BACKGROUND, R.drawable.bgi5);
        mKeyboardView.setBackgroundColor(Color.parseColor("#000000"));
        mKeyboardView.setBackgroundResource(background);
//
//        Bitmap backgroundBitmap = BitmapFactory.decodeResource(mThemeContext.getResources(),background);
//        BitmapDrawable backgroundDrawable = new BitmapDrawable(mThemeContext.getResources(), backgroundBitmap);
///        backgroundDrawable.setGravity(Gravity.FILL_VERTICAL); // also LEFT, CENTER_VERTICAL, etc.
//
//        mKeyboardView.setBackground(backgroundDrawable);
    }
