...
import com.ceara.club.keyboard.utils.SnAudioPlayer;
...
public final class MainKeyboardView extends KeyboardView implements DrawingProxy,
    ...
    private final SnAudioPlayer audioPlayer;
    ...
    public MainKeyboardView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        audioPlayer = new SnAudioPlayer(context);
    }
...
//        boolean isSoundOn = prefs.getBoolean(Settings.PREF_SOUND_ON,
//                Settings.readKeypressSoundEnabled(prefs, getResources()));
//        if (isSoundOn) {
//            audioPlayer.play();
//        }
    }
