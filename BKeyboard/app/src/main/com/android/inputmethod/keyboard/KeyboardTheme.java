...
import static com.ceara.club.keyboard.fragment.HomeFragment.PREF_ANIMATION;
...
public final class KeyboardTheme implements Comparable<KeyboardTheme> {
    ...
    public static final int THEME_ID_LXX_DARK_Y = 4;
    public static final int THEME_ID_LXX_DARK_N = 5;
    public static final int DEFAULT_THEME_ID = THEME_ID_LXX_DARK_Y;

    private static KeyboardTheme[] AVAILABLE_KEYBOARD_THEMES;

    /* package private for testing */
    static final KeyboardTheme[] KEYBOARD_THEMES = {
        new KeyboardTheme(THEME_ID_LXX_LIGHT, "LXXLight",
                R.style.KeyboardTheme_LXX_Light, VERSION_CODES.BASE),
            new KeyboardTheme(THEME_ID_LXX_DARK_Y, "LXXDark_Y",
                R.style.KeyboardTheme_LXX_Dark, VERSION_CODES.BASE),
            new KeyboardTheme(THEME_ID_LXX_DARK_N, "LXXDark_N",
                    R.style.KeyboardTheme_LXX_Dark_No, VERSION_CODES.BASE)
    };

//    static final KeyboardTheme[] KEYBOARD_THEMES_NO = {
//            new KeyboardTheme(THEME_ID_LXX_DARK_N, "LXXDark_N", R.style.KeyboardTheme_LXX_Dark_No,
//                    VERSION_CODES.BASE/*), new KeyboardTheme(THEME_ID_LXX_LIGHT,
//            "LXXLight", R.style.KeyboardTheme_LXX_Light_No,
//            VERSION_CODES.BASE*/)
//    };
    ...
    static void saveKeyboardThemeId(final int themeId, final SharedPreferences prefs,
        ...
        Log.e("error=======","ff+"+prefKey);
        prefs.edit().putString(prefKey, Integer.toString(themeId)).apply();
    }

    public static KeyboardTheme getKeyboardTheme(final Context context) {
        final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        final KeyboardTheme[] availableThemeArray = getAvailableThemeArray(context, prefs);

        return getKeyboardTheme(prefs, BuildCompatUtils.EFFECTIVE_SDK_INT, availableThemeArray);
    }

    /* package private for testing */
    static KeyboardTheme[] getAvailableThemeArray(final Context context, SharedPreferences prefs) {
        ...
        if (AVAILABLE_KEYBOARD_THEMES == null) {
            ...
            for (final int id : availableThemeIdStringArray) {
                ...
                theme = searchKeyboardThemeById(id, KEYBOARD_THEMES);
                if (theme != null) {
