...
final class EmojiLayoutParams {
    ...
    public void setPagerProperties(final ViewPager vp) {
        final LinearLayoutCompat.LayoutParams lp = (LinearLayoutCompat.LayoutParams) vp.getLayoutParams();
    ...
    public void setCategoryPageIdViewProperties(final View v) {
        final LinearLayoutCompat.LayoutParams lp = (LinearLayoutCompat.LayoutParams) v.getLayoutParams();
    ...
    public void setActionBarProperties(final LinearLayout ll) {
        final LinearLayoutCompat.LayoutParams lp = (LinearLayoutCompat.LayoutParams) ll.getLayoutParams();
